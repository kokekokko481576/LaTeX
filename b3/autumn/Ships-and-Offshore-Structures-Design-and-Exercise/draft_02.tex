...
\begin{equation}
    I_B = \frac{\pi (R^4-r^4)}{64}
\end{equation}
また、平行軸の定理より、楕円の短辺半径をBとしたときの断面2次モーメント$I_B$は以下の式で求められる。
\begin{equation}
    I_A = I_B + \frac{\pi}{4}(R^2 - r^2)(A-\frac{R}{2})^2
\end{equation}
以上より4本の円筒柱で構成されるセミサブ浮体の断面2次モーメント$I_{total}$は以下の式で求められる。
\begin{align}
    I_{total} &= 2 I_A + 2 I_B = 2 \left\{ \frac{\pi (R^4-r^4)}{64} + \frac{\pi}{4}(R^2 - r^2)(A-\frac{R}{2})^2 \right\} + 2 \cdot \frac{\pi (R^4-r^4)}{64} \\
    &= \frac{\pi}{16}(R^4 - r^4) + \frac{\pi}{2}(R^2 - r^2) (A-\frac{R}{2})^2
\end{align}
...
よって、BMは以下の式で求められる。
\begin{equation}
    BM = \frac{I_{total}}{V} = \frac{\frac{\pi}{16}(R^4 - r^4) + \frac{\pi}{2}(R^2 - r^2) (A-\frac{R}{2})^2}{4\alpha^3 + \pi R^2 (d-\alpha)}
\end{equation}
...
\begin{equation}
    GM = \frac{2\alpha^4 + \frac{\pi R^2}{2}(d^2 - \alpha^2)}{4\alpha^3 + \pi R^2(d-\alpha)} + \frac{\frac{\pi}{16}(R^4 - r^4) + \frac{\pi}{2}(R^2 - r^2) (A-\frac{R}{2})^2}{4\alpha^3 + \pi R^2 (d-\alpha)} - \frac{2\rho\alpha(\alpha^3 - \beta^3) + \frac{\rho\pi}{2}(R^2-r^2)(h^2-\alpha^2) + M z_M}{4\rho(\alpha^3 - \beta^3) + \rho \pi(R^2-r^2)(h-\alpha) + M}
\end{equation}
